...
import { LayoutDashboard, PlusCircle, Handshake, Wallet, BarChart2 } from 'lucide-react'

const NAV = [
  { href: '/dashboard', icon: LayoutDashboard, label: 'Inicio' },
  { href: '/transactions/new', icon: PlusCircle, label: 'Nueva' },
  { href: '/loans', icon: Handshake, label: 'Préstamos' },
  { href: '/analytics', icon: BarChart2, label: 'Gráficos' },
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 safe-bottom"
      ...
      <div className="flex items-center justify-around px-0 pt-2 pb-1">
